...
define Device/zhao_7981-r128-dsa-mtkuboot
  DEVICE_VENDOR := ZHAO
  DEVICE_MODEL := 7981 R128
  DEVICE_VARIANT := DSA (MTK U-Boot layout)
  DEVICE_DTS := mt7981b-zhao-7981r128-dsa-mtkuboot
  DEVICE_DTS_DIR := ../dts-ext
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += zhao_7981-r128-dsa-mtkuboot
